                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b">
                                                                                        <h1>¡Hello thanks for contacting me!</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                        <p style="font-size: 20px;">your email was received<br>I will contact you in a few moments<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10b">
                                                                                        <h1 style="text-align: center; color: #ffffff;">Thanks for your interest!</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                        <p style="color: #ffffff;">55 1824 8779<br>Miguel Angel Nava Zavala<br>Computer systems engineer<br>guiguelangel@gmail.com</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
